...
RSpec.describe "Workouts", type: :request do
  ...
  let!(:workout) do
    # Definindo calories_burned para evitar problema de nil (opcional se você corrigir no controller)
    Workout.create!(user: user, gym_id: gym.id, workout_protocol: workout_protocol, calories_burned: 100)
  end
